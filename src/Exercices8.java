public class Exercices8 {
    public static void main(String[] args) {
        ...
        //Exercice 8 Ecrire un programme java qui affiche la table de multiplication d'un nombre pair. Le programme doit controler et afficher uniquement les multiples differents du nombre considéré.
